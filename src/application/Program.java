	...
	public static void main(String[] args) {
		...
		while (tb.quantPieceBrancas() != 0 && tb.quantPiecePretas() != 0) {
		  try {
			...
			System.out.println();
			System.out.print("Digite a posicao da peca q voce quer mover: ");
			...
			if(inicio.validarPosicaoInicio(partida,tb) == false) {
				System.out.println("Essa posicao é invalida ");
			}
			
			while (inicio == null || inicio.validarPosicaoInicio(partida,tb) == false) {
				System.out.println();
				tb.imprimirTabuleiro();
				System.out.print("Digite novamente posicao da peca q voce quer mover: ");
		...
		System.out.println("PARABÉNS JOGADOR "+piece.getCor() + "VOCE VENCEU!!!");
